...
namespace Client.Controllers
{
    public class HomeController : Controller
    {
        ...
        {
            var serverResponse = await AccessTokenRefreshWrapper(() => SecuredGetRequest("https://localhost:44344/secret/index"));
            
            var apiResponse = await AccessTokenRefreshWrapper(() => SecuredGetRequest("https://localhost:44365/secret/index"));
        ...
        private async Task RefreshAccessToken()
        {
            ...
            var request = new HttpRequestMessage(HttpMethod.Post, "https://localhost:44344/oauth/token")
            {
